            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="{{ route('master.country.index') }}">Manage {{ $globalTitle }}</a>
                        <span class="icon-angle-right"></span>
                     </li>
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                           <div class="tab-content">
                                 @include('common.msg')
                                 <form action="{{ route('master.country.update',['id'=>$shippingline->id]) }}" method="post" class="form-horizontal">@csrf
                                    ...
                                    <div class="form-actions">
                                       ...
                                       <a href="{{ route('master.country.index') }}" class="btn red">Cancel</a>
                                    </div>
                                 </form>
                                 <!-- END FORM-->  
                           </div>
