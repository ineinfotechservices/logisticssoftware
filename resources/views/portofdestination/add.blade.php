                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                           <div class="tab-content">
                                 @include('common.msg')
                                 <form action="{{ route('master.portofdestination.save') }}" method="post" class="form-horizontal">@csrf
                                ...
                                <div style="min-height:100px"></div>
                                    <div class="form-actions">
                                       ...
                                       <a href="{{ route('master.portofdestination.index') }}" class="btn red">Cancel</a>
                                    </div>
                                 </form>
                                 <!-- END FORM-->  
                           </div>
