            ...
            <div class="span12 responsive" data-tablet="span12 fix-offset">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{{ route('master.portofloading.add') }}" class="btn green"><i class="icon-plus"></i>
                                Add</a>
                                ...
                                @if (isset($shippingline) && is_object($shippingline) && $shippingline->count())
                                    @foreach ($shippingline as $consig)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
											<a href="{{ route('master.portofloading.edit',['id'=>$consig->id]) }}" class="btn green mini"><i class="icon-pencil"></i> Edit</a>
											<a href="javascript:void(0)" onclick=deleteRow('{{ route('master.portofloading.delete',['id'=>$consig->id]) }}') class="btn red mini"><i class="icon-trash"></i> Delete</a>
											</td>
                                        </tr>
                                    @endforeach
                                @else 
