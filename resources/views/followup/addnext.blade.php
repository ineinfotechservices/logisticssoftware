                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        <div class="tab-content">
                            ...
                            <form action="{{ route('master.followup.add_next_followup',['id'=>$id]) }}" method="post" class="form-horizontal"
                                ...
                                <div class="row-fluid">
                                    <div class="span8 ">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" name="description"
                                                    ...
                                                    placeholder="Please provide Description" class="m-wrap" style="width:50%" ></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="next_followup"
                                                    ...
                                                    placeholder="Please provide Next Followup Date/time" style="width:50%" class="m-wrap" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                @if (isset($role_users) && is_object($role_users) && $role_users->count())
                                                    <select name="assign_user_id" id="assign_user_id" class="m-wrap" style="width:50%">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                @if (isset($FollowupStatus) && is_array($FollowupStatus))
                                                    <select name="followup_status" id="followup_status" class="m-wrap" style="width:50%">
                                                        <option value="">Select Status</option>
                                                        @foreach ($FollowupStatus as $key=>$option)
                                                            @if(isset($row->status) && $row->status==$key)
