        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#">Manage Equipment Type</a>
                        {{-- <i class="icon-angle-right"></i> --}}
                    </li>
            ...
            <div class="span12 responsive" data-tablet="span12 fix-offset">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <h4><i class="icon-cogs"></i>Equipment Type Listing</h4>
                        <div class="actions">
                            <a href="{{ route('master.equipmenttype.add') }}" class="btn green"><i class="icon-plus"></i>
                                Add</a>
                                ...
                                @if (isset($shippingline) && is_object($shippingline) && $shippingline->count())
                                    @foreach ($shippingline as $consig)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>{{ $consig->title }}</td>
                                            <td>
											<a href="{{ route('master.equipmenttype.edit',['id'=>$consig->id]) }}" class="btn green mini"><i class="icon-pencil"></i> Edit</a>
											<a href="javascript:void(0)" onclick=deleteRow('{{ route('master.equipmenttype.delete',['id'=>$consig->id]) }}') class="btn red mini"><i class="icon-trash"></i> Delete</a>
											</td>
                                        </tr>
                                    @endforeach
                                @else 
